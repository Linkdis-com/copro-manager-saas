...
import { 
  ...
  ChevronDown, ChevronRight, MapPin, Home, Users as UsersIcon
} from 'lucide-react';
                                  ...
                                  {clientDetails[client.id].immeubles.map((immeuble) => (
                                    ...
                                    >
                                      <div className="flex flex-col h-full">
                                        ...
                                        {/* Actions rapides - Note explicative */}
                                        <div className="mt-4 pt-3 border-t border-gray-100">
                                          <p className="text-xs text-gray-500 italic">
                                            💡 Connectez-vous à l'app utilisateur pour voir les détails
                                          </p>
                                          <div className="mt-2 flex items-center gap-2">
                                            <a
                                              href={`http://localhost:5173/immeubles/${immeuble.id}`}
                                              target="_blank"
